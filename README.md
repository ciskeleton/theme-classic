...
- Issues & feedback: `https://github.com/ciskeleton/packages/issues`
...
return [
    // Info
    'name' => 'Classic',
    'theme_uri' => 'https://github.com/ciskeleton/theme-default/',
...
- **[packages](https://github.com/ciskeleton/packages/tree/main/packages/themes) → packages/themes/classic**
...
If you have suggestions for the theme structure or documentation, open an issue in the appropriate public repo ([`packages`](https://github.com/ciskeleton/packages) or [`theme-classic`](https://github.com/ciskeleton/theme-classic)) or contact the maintainer.
